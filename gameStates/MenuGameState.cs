...
public class MenuGameState : GameState
{
    ...
    public override void Initialize()
    {
        ...
        SplashKit.DrawText("PACMAN", Color.Yellow, ProgramConfig.GameFont, 100, 100, 100);
        ...
        SplashKit.DrawText("Press Space to pause while playing", Color.White, ProgramConfig.GameFont, 15, 100, (double) ProgramConfig.ScreenHeight/2 + 100);
